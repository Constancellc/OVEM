function [max_ice_kw,max_motor_kw,fuel_ice,fuel_motor,motor_eff_f,fgb_to_ICE_b_eff,timestep,v_ach,...
    vgb_mass,batt_kwh,I_ESS1,DoD_ESS1,NoCells_ESS1_par,volume_of_fuel_used_by_ICE]=level_3_pisi_dual_hev3(powertrain_type,v_req,~,timestep,drive_cycle_length,slope,Cd,Af,rho_air,...
