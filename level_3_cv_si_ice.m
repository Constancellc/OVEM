function [max_ice_kw,total_fuel_mj,si_ice_2_eff,timestep,v_ach,vgb_mass,final_veh_mass]=...
...
min_si_ice_2_eff= single(min(min(si_map))/100);
...
[P_f_reqd_by_ice(i),T_f_reqd_by_gb(i),w_f_reqd_by_gb(i),si_ice_2_eff(i)]=...
    ...
    min_w,ice_status,si_map,min_si_ice_2_eff);
...
[P_f_reqd_by_wheelaxle(i),T_f_gb_to_wheelaxle(i),w_f_gb_to_wheelaxle(i),...
    ...
    top_gear_ratio,gear_ratio_vector,final_drive_ratio,gears,w_range,w_b_wheelaxle_to_gb(i));
...
% 
% figure(2)
% plot(F_b_vehicle_to_wheelaxle)
% hold on
% plot(F_f_wheelaxle_to_vehicle,'r')
% ylabel('Force (kN)')
% legend('Vehicle -> wheelaxle','Wheelaxle -> vehicle')
% hold off
% 
% figure(3)
...
% plot(T_b_gb,'g')
% hold on
%  plot(T_f_reqd_by_gb,'r')
% hold on
% plot(T_f_gb_to_wheelaxle,'k')
% ylabel('Torque (Nm)')
