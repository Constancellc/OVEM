...
mixed_logit = 0;
growth_damping = 1;
tvs_growth_rate = 1.0185; %where gr is the user-defined TVS growth rate
invest_mat = zeros(years,6);

TVS=tvs_growth_rate;
DYNAMIC=dynamic_scrap;
LOGIT=mixed_logit;
DAMPING=growth_damping;
...
NOPOLICYCE=ce;
NOPOLICYRA=ra;
NOPOLICYFCWTW=fc_wtw;
NOPOLICYCEWTW=ce_wtw;
