function [max_ice_kw,max_motor_kw,fuel_ice,fuel_motor,motor_eff_f,fgb_to_ICE_b_eff,timestep,v_ach,...
    vgb_mass,batt_kwh,I_ESS1,DoD_ESS1,NoCells_ESS1_par,volume_of_fuel_used_by_ICE]=level_3_pisi_dual_hev2(powertrain_type,v_req,~,timestep,drive_cycle_length,slope,Cd,Af,rho_air,...
...
%ICE
    [w_f_ICE_to_gb(i),T_f_ICE_to_gb(i),ICE_eff(i),volume_of_fuel_used_by_ICE(i)]=...
        ICE_parallel_dual_model(T_b_gb_to_ICE(i),...
        ...
        min_P,ICE_max_torque_w_profile,ICE_max_torque_T_profile,si_map,...
