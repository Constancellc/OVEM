function [max_motor_kw,fuel_motor,motor_eff_f,timestep,v_ach,vgb_mass,batt_kwh,DoD_ESS1,... 
    I_ESS1,V_ESS1,NoCells_ESS1_par,final_veh_mass]=level_3_ev2(powertrain_type,...
...
ICE_mass = 0;
apu_mass = 0;
fgb_ratio = 1;%final1_drive_ratio;
fgb_ICE_ratio = 1;
...
[T_f_motor_to_gb(i),w_f_motor_to_gb(i),motor_eff_f(i)]=motor_forwards_3(P_f_bus_to_motor(i),...
    ...
    T_b_motor_to_elecbus(i),T_max_speed_vector,T_max_profile,number_of_motors);
...
% % plot(P_supp_ESS1)
% % hold on
% plot(P_f_gb_to_wheelaxle/1000)
% hold on
% plot(P_f_bus_to_motor/1000,'r')
% hold on
% plot(T_f_motor_to_gb.*w_f_motor_to_gb/1000,'g')
% hold on
% plot(P_b_wheelaxle_to_gb,'k')
% %plot(cumsum(P_f_bus_to_motor/1000),'r')
% ylabel('Power, kW')
% legend('GB -> wheelaxle','elecbus -> motor','motor -> GB','Wheelaxle -> GB')
% hold off
% % % 
% 
% 
...
% hold on
% plot(T_f_gb_to_wheelaxle)
% hold on
% plot(T_b_wheelaxle_to_gb,'k')
% ylabel('Torque, Nm')
% legend('Motor -> elecbus -> motor','motor -> GB','GB -> Wheelaxle','Wheelaxle -> GB')
% hold off
% 
% % 
% 
% 
% figure(8)
% plot(w_f_gb_to_wheelaxle)
% hold on
% plot(w_f_motor_to_gb,'g')
% hold on
% plot(w_b_motor_to_elecbus,'r')
% hold on
% plot(w_b_wheelaxle_to_gb,'k')
% ylabel('rad/s')
% legend('GB -> Wheelaxle', 'motor -> GB','Motor -> elecbus -> motor','Wheelaxle -> GB')
% hold off
