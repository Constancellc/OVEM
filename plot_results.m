...
%        set(gca,'XTickLabel',{'petrol','diesel','dual hybrid','plugin hybrid','electric','fuel cell'},'FontSize',10);
 set(gca,'XTickLabel',{'PET','DIE','PET HEV','PHEV','EV','FC HEV'},'FontSize',10);
    ...
    elseif VCOMP(4)==2 && a(1)==3;
        NEWBARMJ=MJKMWTW-MJKM;
        STACKMJ=[MJKM(SCC,1) NEWBARMJ(SCC,1);MJKM(SCC,2) NEWBARMJ(SCC,2);MJKM(SCC,3) ...
            NEWBARMJ(SCC,3);MJKM(SCC,4) NEWBARMJ(SCC,4);MJKM(SCC,5) NEWBARMJ(SCC,5);MJKM(SCC,6) NEWBARMJ(SCC,6)];
        bar(STACKMJ,'stack');
%        set(gca,'XTickLabel',{'petrol','diesel','dual hybrid','plugin hybrid','electric','fuel cell'},'FontSize',10);
 set(gca,'XTickLabel',{'PET','DIE','PET HEV','PHEV','EV','FC HEV'},'FontSize',10);
       xlabel('Powertrain');
